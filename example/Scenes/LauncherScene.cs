...
namespace DotFeather.Example
{
    public class LauncherScene : Scene
    {
        ...
        public override void OnStart(Router router, GameBase game, System.Collections.Generic.Dictionary<string, object> args)
        {
			...
			ChangeDirectory(ExampleOS.CurrentDirectory);
        }
		...
		{
			var parent = ExampleOS.CurrentDirectory.Parent;
			if (parent != null && i == 0)
			{
			...
			{
				var el = ExampleOS.CurrentDirectory.Files[parent != null ? i - 1 : i];
				switch (el)
				{
					case Folder f:
						ChangeDirectory(f);
		...
		{
			ExampleOS.CurrentDirectory = folder;
